...
CREATE TABLE IF NOT EXISTS `sessiondata` (`uid` CHAR(32) NOT NULL COMMENT 'user_idから算出したUID', `data` TEXT DEFAULT '' COMMENT 'jsonシリアライズされたセッションデータ', `created` TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '作成日時', `modified` TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '更新日時', PRIMARY KEY(`uid`)) ENGINE = MYISAM;
-- user recode--
