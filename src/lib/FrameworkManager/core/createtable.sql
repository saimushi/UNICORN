...
CREATE TABLE IF NOT EXISTS `sessiondata` (`uid` CHAR(32) NOT NULL COMMENT 'user_idから算出したUID', `data` TEXT DEFAULT NULL COMMENT 'jsonシリアライズされたセッションデータ', `modified` TIMESTAMP NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '変更日時', PRIMARY KEY(`uid`)) ENGINE = MYISAM;
