...
class Utilities {
	...
	public static function doHexEncryptAES($argValue, $argKey, $argIV = null, $argPrefix = '', $argSuffix = '') {
		return bin2hex(self::encryptAES($argValue, $argKey, pack("H*", $argIV), $argPrefix, $argSuffix));
	}
	...
	public static function doHexDecryptAES($argValue, $argKey, $argIV = null, $argPrefix = '', $argSuffix = '') {
		return self::decryptAES(pack("H*", $argValue), $argKey, pack("H*", $argIV), $argPrefix, $argSuffix);
	}
